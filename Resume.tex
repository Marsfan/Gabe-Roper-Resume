...
\begin{document}
	...
	\begin{Body}
        ...
        \Section{Work Experience}
            \PositionYM{L3Harris ACSS}{2019}{05}{2019}{08}
            ...
            \PositionYM{National Aeronautics and Space Administration}{2018}{06}{2018}{08}
		...
		\Section{Skills}
            ...
            \begin{skillTable}
                ...
                \skillCategory{Other Software}{Blender Animation, Microsoft Windows, Linux (Debian and Arch based)}\\

                \skillCategory{Programming Languages}{Arduino, Python, MATLAB, C, Basic VHDL, LaTeX}\\

                \skillCategory{Technical}{Woodworking, Soldering, PCB Design, 3D Printing, Amplifier Design, Control Systems, Signal Analysis, Cypress PSOC, TI Launchpad}
