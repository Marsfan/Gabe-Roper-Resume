...
\begin{Body}
	...
	\Entry
		...
		\begin{Detail}
			\Item
				\begin{minipage}{\descriptionWidth}
					Member of electrical engineering team that is mounting a number of sensors to a student-built Van's RV-12 for analyzing the stress and aerodynamic effects on the aircraft.
				\end{minipage}
		\end{Detail}
	\BigGap
	\Entry
		\textbf{CHS FIRST Robotics Team}
	...
	\Entry
	\textbf{Usedave.com}\hfill \ymRange{2015}{06}{2015}{08}
	\begin{Detail}
		\textit{Freelance 3D Modeling}
		\Item
		\begin{minipage}{\descriptionWidth}
			Created 3D models for corporate internal marketing comic book.
		\end{minipage}
	\end{Detail}
	\Gap

	\Entry
	\textbf{National Aeronautics and Space Administration}\hfill\ymRange{2018}{06}{2018}{08}
	\begin{Detail}
		\textit{Human-Spacesuit Integration Intern -- Anthropometrics and Biomechanics Facility}
		\Item
		\begin{minipage}{\descriptionWidth}
			Developed software for analyzing human-spacesuit interaction
		\end{minipage}
	\end{Detail}
	\Gap

	\Entry
	\textbf{L3Harris ACSS}\hfill\ymRange{2019}{05}{2019}{08}
	\begin{Detail}
