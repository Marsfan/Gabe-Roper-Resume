	...
	\begin{Body}
        ...
        \Section{Skills}
            \begin{skillTable}
                ...
                \skillCategory{Other Software}{Blender Animation, Unity Game Engine (Basic), Microsoft Windows, Linux (Debian and Arch based), ESA SNAP, Google Earth Engine}\\

nk                \skillCategory{Programming Languages}{Arduino, Python, MATLAB, C, Basic VHDL, LaTeX, Simulink}\\
		...
		\Section{Awards}
            ...
            \Entry Eagle Scout
            \Entry Embry-Riddle Aeronautical University Deans List
	\end{Body}
