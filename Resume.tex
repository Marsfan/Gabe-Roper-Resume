...
\begin{document}
	...
	\begin{Body}
		...
		\Section{Education}
            ...
            Bachelor of Science in Electrical Engineering %, Robotics Track % Add this in if applying for a robotics job.
            \hfill May 2021
        ...
        \PositionY{Senior Capstone}{2020}{2021}
        ...
        \Section{Skills}
            \begin{skillTable}
                \skillCategory{Engineering Software}{SOLIDWORKS, KiCAD, LabVIEW, MakerBot Desktop, CATIA, MPLAB X, Eagle, PyCharm, IAR Embedded Workbench, Git, ANSYS Mechanical Workbench}\\
